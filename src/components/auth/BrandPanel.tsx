...
const FEATURES = [
  ...
  // Прежний текст обещал подписанный журнал и выключённый обмен. Журнал стал
  // обычным аудит-логом по решению заказчика, а обмен на сервере включён —
  // оба утверждения вводили человека в заблуждение с первого экрана.
  { icon: Network, text: 'Журнал операций с автором и причиной; обмен с офисными узлами' },
]
